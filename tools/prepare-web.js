...
const FILES=['index.html','trade-plan.html','app.js','bbma-runtime.js','bbma-dashboard-ui.js','bbma-link.js','trade-plan.js','live.js','shared-market-logic.js',
...
/* APK-only enhancement: runtime first, dashboard second, query/deep-link router last. */
...
if(fs.existsSync(indexOut)){
  ...
  let extra='';
  if(!html.includes('bbma-runtime.js'))extra+='\n  <script src="./bbma-runtime.js"></script>';
