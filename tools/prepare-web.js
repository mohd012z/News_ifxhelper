...
const FILES=['index.html','trade-plan.html','app.js','bbma-runtime.js','bbma-dashboard-ui.js','bbma-router-fix.js','bbma-link.js','trade-plan.js','live.js','shared-market-logic.js','xauusd-data.js','atr.js','news-auto.js','macro-auto.js','data-manifest.json','manifest.webmanifest','sw.js','pwa.js'];
...
console.log('www/ ready with '+n+' files -> '+out);console.log('Bundled data is fallback. data-manifest.json identifies exactly what this APK contains.');
