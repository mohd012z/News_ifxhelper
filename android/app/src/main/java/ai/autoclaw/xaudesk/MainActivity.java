...
/**
 * XAU//DESK host activity.
 *
 * Notification/deep-link contract:
 *   xau-desk://bbma?alertId=<id>&tf=H1
 *   https://.../?open=bbma&alertId=<id>&tf=H1
 *
 * The native layer does not invent a trading signal. It only routes an
 * already-created alert to the matching BBMA dashboard/timeframe.
 */
