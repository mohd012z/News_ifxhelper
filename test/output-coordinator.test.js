...
assert.equal(health.components.market,'GREEN');assert.equal(health.components.news,'RED');assert.equal(health.components.learning,'GRAY');assert.equal(health.overall,'YELLOW');
